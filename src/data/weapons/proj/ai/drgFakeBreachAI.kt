...
import data.drgUtils.lerp
import org.lazywizard.lazylib.ext.plus

// a kotlin adaptation (and improvement) of magiclib missile AI
class drgFakeBreachAI(val missile: MissileAPI, val launchingShip: ShipAPI): MissileAIPlugin, GuidedMissileAI
{
    // SETTINGS
    companion object
    {
        ...
        const val PREDICTIVE_INTERCEPT = false
    }
