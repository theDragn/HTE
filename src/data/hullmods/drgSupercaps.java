...
public class drgSupercaps extends BaseHullMod
{
    ...
    public static final float ENERGY_WEP_DAMAGE_BONUS = 66f;
    public static final float BEAM_DAMAGE_BONUS = 25f;
    public static final float ENERGY_WEP_FLUX_BONUS = 25f;

    @Override
    public void applyEffectsBeforeShipCreation(HullSize hullSize, MutableShipStatsAPI stats, String id)
    {

        // this is probably hugely fucky if another mod has something that modifies
        // weapon damage
        ...
        // apply the inverse of the buff as a debuff to beams so that their damage is
        // unaffected
