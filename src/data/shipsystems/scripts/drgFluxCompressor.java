...
public class drgFluxCompressor extends BaseShipSystemScript {
    ...
    private static Color ENGINE_COLOR = Color.MAGENTA;
	...
	public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
        ...
        {
            ship.getEngineController().extendFlame(this, 2.5f * effectLevel, 1.5f * effectLevel, 1.5f * effectLevel);
            ship.getEngineController().fadeToOtherColor(this, ENGINE_COLOR, Color.WHITE, effectLevel, 0.75f);
        }
    }
